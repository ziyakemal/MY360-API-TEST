Feature: Book Appointments Services
  ...
  Scenario: GetDoctorReportsByPersonId
    When I make a "POST" request with the "AuthV3" endpoints on the "LoginEntries" page.
    When I get the "TOKEN" information returned from the response.
    When I get the "VALIDATION_CODE" information returned from the response.
    When I make a "POST" request with the "OTPConfirmation" endpoints on the "LoginEntries" page.
    When I get the "TOKEN" information returned from the response.
    When Latest version of token information
    When Read query string from json file and make GET request with "GetDoctorReportsByPersonId" in "BookAppointmentsEntries"
    Then Compare the expected response with the returned response according to the "GetDoctorReportsByPersonId" service
    Then the response has a status code of 200

  Scenario: GetCalendar10
    When I make a "POST" request with the "AuthV3" endpoints on the "LoginEntries" page.
    When I get the "TOKEN" information returned from the response.
    When I get the "VALIDATION_CODE" information returned from the response.
    When I make a "POST" request with the "OTPConfirmation" endpoints on the "LoginEntries" page.
    When I get the "TOKEN" information returned from the response.
    When Latest version of token information
    When Read query string from json file and make GET request with "GetCalendar10" in "BookAppointmentsEntries"
    Then Compare the expected response with the returned response according to the "GetCalendar10" service
    Then the response has a status code of 200

  Scenario: InsertAppointment
    When I make a "POST" request with the "AuthV3" endpoints on the "LoginEntries" page.
    When I get the "TOKEN" information returned from the response.
    When I get the "VALIDATION_CODE" information returned from the response.
    When I make a "POST" request with the "OTPConfirmation" endpoints on the "LoginEntries" page.
    When I get the "TOKEN" information returned from the response.
    When Latest version of token information
    When I make a "POST" request with the "InsertAppointment" endpoints on the "BookAppointmentsEntries" page.
    Then Compare the expected response with the returned response according to the "InsertAppointment" service
    Then the response has a status code of 200

  Scenario: GetFacilitiesWithMapping
    When I make a "POST" request with the "AuthV3" endpoints on the "LoginEntries" page.
    When I get the "TOKEN" information returned from the response.
    When I get the "VALIDATION_CODE" information returned from the response.
    When I make a "POST" request with the "OTPConfirmation" endpoints on the "LoginEntries" page.
    When I get the "TOKEN" information returned from the response.
    When Latest version of token information
    When Read query string from json file and make GET request with "GetFacilitiesWithMapping" in "BookAppointmentsEntries"
    Then Compare the expected response with the returned response according to the "GetFacilitiesWithMapping" service
    Then the response has a status code of 200

  Scenario: GetPatientAppointmentsDrCode
    When I make a "POST" request with the "AuthV3" endpoints on the "LoginEntries" page.
    When I get the "TOKEN" information returned from the response.
    When I get the "VALIDATION_CODE" information returned from the response.
    When I make a "POST" request with the "OTPConfirmation" endpoints on the "LoginEntries" page.
    When I get the "TOKEN" information returned from the response.
    When Latest version of token information
    When Read query string from json file and make GET request with "GetPatientAppointmentsDrCode" in "BookAppointmentsEntries"
    Then Compare the expected response with the returned response according to the "GetPatientAppointmentsDrCode" service
    Then the response has a status code of 200

  Scenario: GetPatientDoctors
    When I make a "POST" request with the "AuthV3" endpoints on the "LoginEntries" page.
    When I get the "TOKEN" information returned from the response.
    When I get the "VALIDATION_CODE" information returned from the response.
    When I make a "POST" request with the "OTPConfirmation" endpoints on the "LoginEntries" page.
    When I get the "TOKEN" information returned from the response.
    When Latest version of token information
    When Read query string from json file and make GET request with "GetPatientDoctors" in "BookAppointmentsEntries"
    Then Compare the expected response with the returned response according to the "GetPatientDoctors" service
    Then the response has a status code of 200